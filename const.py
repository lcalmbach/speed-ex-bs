...
if socket.gethostname().lower() in DEV_MACHINES:
    ...
    DB_PASS = 'e0c9a015d85ea63840127ed9ace7aa9ce9ffe82ff602581e4ab65b014fc48239' # LC: todo: fix: os.environ.get('DB_PSSWD') # read from system variables when on heroku
